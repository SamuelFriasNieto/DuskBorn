          ...
          <div className='flex items-center gap-5 mr-5'>
              ...
              <div ref={dropdownRef} className='group relative cursor-pointer'>
                ...
                <div className='flex flex-col gap-2 w-36 py-3 px-5 bg-ashen-grey/80 text-broken-white rounded'>
                  <p onClick={() => navigate('/profile')} className='cursor-pointer hover:text-crimson hover:brightness-160'>My Profile</p>
                  <p onClick={() => navigate('/orders')} className='cursor-pointer hover:text-crimson hover:brightness-160'>Orders</p>
                  <p onClick={logout} className='cursor-pointer hover:text-crimson hover:brightness-160'>Logout</p>
                </div>
              </div>}
              ...
              <Link to={'/cart'} className='relative'>
                ...
                <p className='absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4 bg-crimson text-broken-white aspect-square rounded-full text-[8px]'>{getCartCount()}</p>
              </Link>
            </div>
